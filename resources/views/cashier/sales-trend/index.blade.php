...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-500">View your sales performance over time</p>
    </div>

    <!-- Period Toggle Buttons -->
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-4 mb-6">
        <div class="flex flex-wrap gap-2">
            <a href="{{ route('cashier.sales-trend.index', ['period' => 'daily']) }}" 
            ...
            <a href="{{ route('cashier.sales-trend.index', ['period' => 'weekly']) }}" 
            ...
            <a href="{{ route('cashier.sales-trend.index', ['period' => 'monthly']) }}" 
            ...
            <a href="{{ route('cashier.sales-trend.index', ['period' => 'yearly']) }}" 
